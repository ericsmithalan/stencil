...
import { ITheme, DarkTheme, LightTheme } from "@stencil.features/theme";
...
export class ThemeService extends React.Component<
    IThemeProviderProps,
    IThemeProviderState
> {
    ...
    public constructor(props: IThemeProviderProps) {
        super(props);
